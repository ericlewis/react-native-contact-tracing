...
// All rights reserved.
//
// This file was originally created by Mattt and can be found here:
// https://github.com/NSHipster/ContactTracing-Framework-Interface/blob/master/ContactTracing.h
...
typedef NS_ENUM(NSInteger, CTManagerState) {
    CTManagerStateUnknown,
    CTManagerStateOn,
    CTManagerStateOff,
};
